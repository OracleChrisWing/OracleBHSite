    ...
    $.fn.extend({
        jTLine: function (options) {
            ...
            var _initTimeLine = function (timeline) {
				...
				/*
					Allows the nodes within the timeline to be 'clicked' by jQuery call. Currently done every 5 seconds, however when the 
					videos are intergratd this will be done at key-points in the video cycle.
				*/
				counter = 1;
				var interval_ID = setInterval(addNewContentFrame, 5000);
            ...
            */
            ...
            var _constructDom = function (jsonData, mainObject) {
                ...
                for (var i = 0; i < dataCollection.length; i++) {
					...
					// Instead of #0, the href destination has been replaced with #i, therefore now making each link unique and jQuery-clickable.
                    $liTimeLineCollection += '<li><a href="#' + i +'" data-date="' + point.dateValue + '" ';
