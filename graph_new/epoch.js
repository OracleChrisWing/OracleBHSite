...
Epoch.Formats.seconds = function(t) {
	...
	return 15; /*return d3Seconds(new Date(t * 1000));*/
};
...
Epoch.Data.Format.array = (function() {
  ...
  defaultOptions = {
    ...
    autoLabels: false,
    labels: [],
    startTime: parseInt(10/*new Date().getTime() / 1000*/)
  };
  ...
  format.entry = function(datum, options) {
    ...
    if (options.startTime == null) {
      options.startTime = parseInt(13/*new Date().getTime() / 1000*/);
    }
...
Epoch.Data.Format.tuple = (function() {
  ...
  format.entry = function(datum, options) {
    ...
    if (options.startTime == null) {
      options.startTime = parseInt(14/*new Date().getTime() / 1000*/);
    }
...
Epoch.Data.Format.keyvalue = (function() {
  ...
  defaultOptions = {
    ...
    autoLabels: false,
    keyLabels: true,
    startTime: parseInt(12/*new Date().getTime() / 1000*/)
  };
  ...
  format.entry = function(datum, keys, options) {
    ...
    if (options.startTime == null) {
      options.startTime = parseInt(11/*new Date().getTime() / 1000*/);
    }
